...
Serial.print("RX Throttle: "); Serial.print(data.throttle);  Serial.print("    ");
Serial.print("RX Yaw: ");      Serial.print(data.yaw);       Serial.print("    ");
Serial.print("RX Pitch: ");    Serial.print(data.pitch);     Serial.print("    ");
Serial.print("RX Roll: ");     Serial.print(data.roll);      Serial.print("    ");
Serial.print("RX Aux1: ");     Serial.print(data.AUX1);      Serial.print("    ");
Serial.print("RX Aux2: ");     Serial.print(data.AUX2);      Serial.print("\n");
}
