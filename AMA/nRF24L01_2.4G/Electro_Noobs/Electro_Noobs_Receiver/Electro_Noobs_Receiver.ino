...
void loop()
{
  ...
  // This is not the PPM version
  // This is not the PPM version
  // This is not the PPM version
  // This is not the PPM version
  // This is not the PPM version
  
  if (true)// This is not the PPM version
  {
    ...
    Serial.print(" AUX 2: ");
    Serial.print(pwm_width_7);
    Serial.print(" ");
    Serial.println("");  
  }
  if (false)// This is not the PPM version
  {
    Serial.print(" Throttle: ");
...
if(currentMillis - previousMillis < PWM_period) //we need a 16ms period of the signal.
 {
  ...
  {
    PORTD |= B00000010;    // Sets to HIGH D6.     
  }
