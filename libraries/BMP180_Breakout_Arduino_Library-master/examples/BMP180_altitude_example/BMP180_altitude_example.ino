...
pressure.getTemperature(currentTemperatureC);
 ...
 double currentTemperatureF = (9.0/5.0)*currentTemperatureC+32.0;
  ...
  if (status != 0)
  {
    ...
    if (status != 0)
    {
      ...
      if (status != 0)
      {
        ...
        else Serial.println("4 error retrieving pressure measurement\n");
      }
      else Serial.println("3 error starting pressure measurement\n");
    }
    else Serial.println("2 error retrieving temperature measurement\n");
  }
  else Serial.println("1 error starting temperature measurement\n");
}
